      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              "{}, you are **not subscribed** to my [channel](https://t.me/Lexiebotupdate) yet. Please [join](https://t.me/Lexiebotupdate) and **press the button below** to unmute yourself.".format(message.from_user.mention, channel, channel),
    ...
    if len(message.command) > 1:
      ...
      if input_str.lower() in ("off", "no", "disable"):
        ...
        try:
          ...
          message.reply_text(f"✅ **Force Subscribe is Enabled**\n__Force Subscribe is enabled, all the group members have to subscribe this [channel](https://t.me/Lexiebotupdate) in order to send messages in this group.__", disable_web_page_preview=True)
        except UserNotParticipant:
          message.reply_text(f"❗ **Not an Admin in the Channel**\n__I am not an admin in the [channel](https://t.me/Lexiebotupdate). Add me as a admin in order to enable ForceSubscribe.__", disable_web_page_preview=True)
